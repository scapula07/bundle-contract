...
contract BundleToken is ERC20("Bundle", "BDL"), Ownable {
    ...
    uint256 public constant MANUAL_MINT_LIMIT = 10500000e18; // 10.5 million Bundle
    ...
    function unlock() external {
        require(_locks[msg.sender] > 0, "no locked BUNDLE");
    ...
    function delegateBySig(
        ...
        require(signatory != address(0), "Bundle::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Bundle::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "Bundle::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "Bundle::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(block.number, "Bundle::_writeCheckpoint: block number exceeds 32 bits");
